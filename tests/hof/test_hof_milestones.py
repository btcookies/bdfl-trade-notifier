...
def test_high_score_and_top_starter(league, tables):
    ...
    # Week 4's QB pool is just a1 (30.0) and a3 (20.0); the median of two is the better score, a1's
    # own 30.0, so a1's vor that week is 0.0.
    assert facts.top_starter == ("QB A1", "Alpha", 30.0, 0.0)
...
def test_season_awards(league, tables):
    ...
    # 2020 vor totals: a1 10.0, a3 -4.0, a2 -18.0, a4 -26.0 (see test_hof_franchises); a1 is best.
    assert awards.best_vor == ("QB A1", "Alpha", 10.0)
