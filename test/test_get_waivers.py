...
def setup_dynamodb():
    with mock_dynamodb2():
        ...
        waivers_table.update_item(
            Key={"key": "1608890400-Josh-Oliver-JAC-TE"},
        ...
        players_table.update_item(
            Key={"id": "14209"},
            ExpressionAttributeNames={"#N": "name", "#P": "position", "#T": "team"},
            ExpressionAttributeValues={":n": "Josh Oliver", ":p": "TE", ":t": "JAC"},
            UpdateExpression="SET #N=:n, #P=:p, #T=:t",
        )
        players_table.update_item(
            Key={"id": "11247"},
            ExpressionAttributeNames={"#N": "name", "#P": "position", "#T": "team"},
            ExpressionAttributeValues={":n": "Zach Ertz", ":p": "TE", ":t": "PHI"},
            UpdateExpression="SET #N=:n, #P=:p, #T=:t",
        )
